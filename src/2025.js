...
export const regExpEscape = RegExp.escape || function (string) {
...
export const iteratorFrom = gIterator.from || function *(iteratorLike) {
...
define(gIterator, "from", iteratorFrom);
